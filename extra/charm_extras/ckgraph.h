...
class ProcInfo {
  ...
  public:
    ...
    inline void setTotalLoad(double load) { _totalLoad = load; }
...
class Vertex {
  ...
  public:
    ...
    inline void setVertexLoad(double load) { compLoad = load; }
    ...
    // added by llpilla
    static bool compareHigherVertexLoad(Vertex a, Vertex b){ return ( a.getVertexLoad() > b.getVertexLoad() ); }
