#!/bin/bash
# File: "/home/pilla/hieschella/hieschella/src/scripts/Results/parse_results.sh"
# Created: "Tue, 09 Oct 2012 13:56:15 +0200 (pilla)"
# Updated: "Mon, 17 Dec 2012 10:18:11 +0800 (pilla)"
...
MACHINE=machine
DATE=date
RESULTS_PATH=$HOME/Results/${MACHINE}/${DATE}/results
#/results
...
APPS="kneighbor leanmd lb_test stencil4d"
